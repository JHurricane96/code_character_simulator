...
state::State MakeState(state::Terrain terrain)
{
	...
	scouts[0][0] = std::shared_ptr<state::Scout>(new state::Scout(6, state::PLAYER1, 0, 300, 100, 37, 10,
	...
	scouts[1][0] = std::shared_ptr<state::Scout>(new state::Scout(7, state::PLAYER2, 0, 300, 100, 37, 10,
...
int main(int argc, char * argv[])
{
	...
	drivers::MainDriver driver(player::PlayerAi(std::shared_ptr<player::PlayerAiHelper>(new ai1::Ai1())),
		player::PlayerAi(std::shared_ptr<player::PlayerAiHelper>(new ai1::Ai1())), S, S1, S2, 5 * 60 * 1000);
